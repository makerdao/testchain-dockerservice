defmodule Docker.BackendProxyNodeConnector do
  @moduledoc """
  ...
  defp backend_node(), do: Application.get_env(:docker, :backend_proxy_node)

  # Timeout generation for reconnect
  defp timeout(),
    do: Application.get_env(:docker, :backend_proxy_node_reconnection_timeout, 10_000)
end
